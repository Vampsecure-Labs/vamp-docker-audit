...
- **Remotos**: `github` (Vampsecure-Labs/vamp-docker-audit) y `forgejo` (vampsecure/vamp-docker-audit). Nunca `origin`.

## Código

- Comentarios y documentación en **español**.
- Sin referencias a IA como autora (Claude, Anthropic, Copilot…) en comentarios, docstrings ni cabeceras.
